...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO customer_detials (CusName, CusAddress, CusTeleNo, CusEmail, Password) VALUES (:fullname, :address, :telephone, :email, :password)";
    ...
    if($stmt) {
        ...
        $error = "Registration failed"; // Handle registration failure
    }
}
// Retrieve the latest CusID from the database
$sql = "SELECT MAX(CusID) AS max_id FROM customer_detials";
$stmt = $pdo->query($sql);
$row = $stmt->fetch(PDO::FETCH_ASSOC);
$max_id = $row['max_id'];
// Increment the CusID for the next user
$username = ($max_id + 1);
?>
                ...
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <form method="POST" action="Signup.php">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="password" class="form-control" id="confirm_password"
                                        name="confirm_password" placeholder="EX: 01" required>
                            ...
                            <p class="text-center mb-4">Do you have an account with us. <a href="Login.php">Log in</a>
                            </p>
                        </div>
