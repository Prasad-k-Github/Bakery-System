...
<body>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    ...
                                    <a href="Login.php" class="btn btn-primary rounded-pill py-3 px-5">Buy our
                                        product</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="h-100">
                            ...
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="Login.php">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-xxl bg-light my-6 py-6 pb-0">
            <div class="container">
                ...
                <?php
                    ...
                    // Execute the query
                    $cursor = $mongoClient->executeQuery('nibm.massege', $query);
    ...
    <section id="Contact">
        <div class="container-xxl py-6">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                    <p class="text-primary text-uppercase mb-2">// Feedback</p>
                    <h1 class="display-6 mb-4">If You Have Any Feedback, Please feel free to tell Us</h1>
                </div>
                    ...
                    <form action="mongo.php" method="post"> 
                        <div class="row g-3">
                            ...
                            <div class="col-12 text-center">
                                <input class="btn btn-primary rounded-pill py-3 px-5" type="submit" name="btnSubmit" value = "Give us your Feedback">
                            </div>
                        </div>
                    </form>
