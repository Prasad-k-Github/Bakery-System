...
<body>
    ...
    <div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center pt-5 pb-3">
            <h1 class="display-4 text-white animated slideInDown mb-3">Payment detials</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Login</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Payment detials</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="name" placeholder="EX: 01">
                            ...
                            <div class="col-6">
                                <div class="form-floating">
                                    ...
                                    <label for="subject">Payment date</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                            ...
                            <div class="col-12 text-center">
                                <a href="" class="btn btn-primary rounded-pill py-3 px-5">Place Order</a>
                            </div>
                            <p class="text-center mb-4"><a href="Login.html">Back</a></p>
                        </div>
                    </form>
                </div>
            </div>
